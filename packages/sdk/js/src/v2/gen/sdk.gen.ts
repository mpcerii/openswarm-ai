...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the openSwarm system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the openSwarm system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the openSwarm server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local openSwarm state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global openSwarm configuration settings and preferences.
   */
   ...
   *
   * Update global openSwarm configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the openSwarm server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the openSwarm system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all openSwarm instances, releasing all resources.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current openSwarm configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update openSwarm configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current openSwarm instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the openSwarm system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with openSwarm.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that openSwarm is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by openSwarm.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all openSwarm sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new openSwarm session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific openSwarm session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Session3 extends HeyApiClient {
   ...
   *
   * Retrieve foreground Session drains currently owned by this openSwarm process. Sessions absent from the result are inactive.
   */
   ...
   *
   * Interrupt active execution owned by this openSwarm process. Idle interruption is a no-op.
   */
