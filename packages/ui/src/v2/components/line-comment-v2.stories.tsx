...
const docs = `### Overview
Line comment **display** and **editor** cards aligned with openSwarm line-comment specs (raised \`#FAFAFA\` surface, footer line context, \`ButtonV2\` neutral + contrast actions).
