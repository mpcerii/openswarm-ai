export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von openSwarm wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
