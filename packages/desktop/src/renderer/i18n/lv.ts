export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko openSwarm versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "openSwarm versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
