export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of openSwarm has been downloaded, would you like to install it and relaunch?",
