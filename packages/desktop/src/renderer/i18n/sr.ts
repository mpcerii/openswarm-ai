export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од openSwarm је преузета, да ли желите да је инсталирате и поново покренете?",
