export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av openSwarm er lastet ned. Vil du installere den og starte på nytt?",
