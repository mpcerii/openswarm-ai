export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'openSwarm a été téléchargée. Voulez-vous l'installer et relancer l'application ?",
