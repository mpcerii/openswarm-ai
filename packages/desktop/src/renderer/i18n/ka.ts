export const dict = {
  ...
  "desktop.updater.none.message": "თქვენ უკვე იყენებთ openSwarm-ის უახლეს ვერსიას",
  ...
  "desktop.updater.downloaded.prompt":
    "openSwarm-ის {{version}} ვერსია ჩამოტვირთულია, გსურთ მისი ინსტალაცია და ხელახლა გაშვება?",
