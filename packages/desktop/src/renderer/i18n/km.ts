export const dict = {
  ...
  "desktop.updater.none.message": "អ្នកកំពុងប្រើកំណែចុងក្រោយនៃ openSwarm រួចហើយ",
  ...
  "desktop.updater.downloaded.prompt":
    "កំណែ {{version}} នៃ openSwarm ត្រូវបានទាញយក តើអ្នកចង់ដំឡើងវា ហើយចាប់ផ្ដើមឡើងវិញទេ?",
