export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace openSwarm. Chcete ji nainstalovat a aplikaci znovu spustit?",
