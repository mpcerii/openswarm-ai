export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "openSwarm versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
