export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} openSwarm telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
