export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} openSwarm завантажено. Бажаєте встановити її та перезапустити?",
