export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią openSwarm versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "openSwarm versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
