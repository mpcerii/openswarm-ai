export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju openSwarm-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} openSwarm-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
