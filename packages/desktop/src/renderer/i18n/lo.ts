export const dict = {
  ...
  "desktop.updater.none.message": "ທ່ານກຳລັງໃຊ້ openSwarm ເວີຊັນຫຼ້າສຸດຢູ່ແລ້ວ",
  ...
  "desktop.updater.downloaded.prompt":
    "ເວີຊັນ {{version}} ຂອງ openSwarm ໄດ້ຖືກດາວໂຫຼດແລ້ວ, ທ່ານຕ້ອງການຕິດຕັ້ງມັນ ແລະເປີດຄືນໃໝ່ບໍ?",
