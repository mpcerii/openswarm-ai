export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent d'openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} d'openSwarm. Voleu instal·lar-la i reiniciar l'aplicació?",
