export const dict = {
  ...
  "desktop.updater.none.message": "شما در حال حاضر از آخرین نسخه openSwarm استفاده می کنید",
  ...
  "desktop.updater.downloaded.prompt":
    "نسخه {{version}} openSwarm دانلود شده است، آیا می خواهید آن را نصب کنید و دوباره راه اندازی کنید؟",
