export const dict = {
  ...
  "desktop.updater.none.message": "คุณกำลังใช้ openSwarm เวอร์ชันล่าสุดอยู่แล้ว",
  ...
  "desktop.updater.downloaded.prompt":
    "ดาวน์โหลด openSwarm เวอร์ชัน {{version}} แล้ว คุณต้องการติดตั้งและเปิดแอปอีกครั้งหรือไม่",
