export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от openSwarm е изтеглена. Искате ли да я инсталирате и рестартирате?",
