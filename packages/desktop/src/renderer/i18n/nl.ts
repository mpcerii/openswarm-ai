export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van openSwarm is gedownload. Wil je deze installeren en openSwarm opnieuw starten?",
