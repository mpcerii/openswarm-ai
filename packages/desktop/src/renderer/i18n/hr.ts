export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije openSwarm. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
