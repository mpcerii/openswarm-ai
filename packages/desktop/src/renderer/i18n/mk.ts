export const dict = {
  ...
  "desktop.updater.none.message": "Веќе ја користите најновата верзија на openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзијата {{version}} од openSwarm е преземена, дали сакате да ја инсталирате и повторно да ја стартувате?",
