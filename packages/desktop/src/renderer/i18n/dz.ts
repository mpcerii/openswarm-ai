export const dict: Record<string, string> = {
  ...
  "desktop.updater.none.message": "ཁྱོད་ཀྱིས་ཧེ་མ་ལས་ openSwarmགི་ཐོན་རིམ་གསརཔ་འདི་ལག་ལེན་འཐབ་དོ།",
  ...
  "desktop.updater.downloaded.prompt":
    "openSwarm གི་ཐོན་རིམ་ {{version}} ཕབ་ལེན་འབད་ཡོདཔ་ལས་ གཞི་བཙུགས་འབད་དེ་ ལོག་འགོ་བཙུགས་ནི་ཨིན་ན?",
