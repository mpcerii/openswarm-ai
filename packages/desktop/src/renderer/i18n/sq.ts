export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i openSwarm është shkarkuar, dëshironi ta instaloni dhe rinisni?",
