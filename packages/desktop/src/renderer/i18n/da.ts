export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af openSwarm er blevet downloadet. Vil du installere den og genstarte?",
