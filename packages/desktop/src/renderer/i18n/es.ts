export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de openSwarm. ¿Quieres instalarla y reiniciar?",
