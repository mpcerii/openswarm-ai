export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} openSwarm je bila prenesena, jo želite namestiti in znova zagnati?",
