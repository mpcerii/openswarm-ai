export const dict: Record<string, string> = {
  ...
  "desktop.updater.none.message": "ඔබ දැනටමත් openSwarm හි නවතම අනුවාදය භාවිතා කරයි",
  ...
  "desktop.updater.downloaded.prompt":
    "openSwarm හි {{version}} අනුවාදය බාගෙන ඇත, ඔබ එය ස්ථාපනය කර නැවත දියත් කිරීමට කැමතිද?",
