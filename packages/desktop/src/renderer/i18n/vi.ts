export const dict = {
  ...
  "desktop.updater.none.message": "Bạn đang sử dụng phiên bản mới nhất của openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Phiên bản {{version}} của openSwarm đã được tải xuống, bạn có muốn cài đặt và khởi chạy lại không?",
