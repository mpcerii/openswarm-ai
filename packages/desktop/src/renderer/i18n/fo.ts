export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av openSwarm.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av openSwarm er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
