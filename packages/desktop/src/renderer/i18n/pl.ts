export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} openSwarm. Czy chcesz ją zainstalować i uruchomić ponownie?",
