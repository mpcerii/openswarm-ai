export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do openSwarm foi baixada. Você gostaria de instalá-la e reiniciar?",
