export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} openSwarm a fost descărcată. Vrei să o instalezi și să repornești?",
