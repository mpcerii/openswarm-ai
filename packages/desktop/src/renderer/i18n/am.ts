export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የopenSwarm ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከopenSwarm ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
