export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di openSwarm è stata scaricata. Vuoi installarla e riavviare l'app?",
