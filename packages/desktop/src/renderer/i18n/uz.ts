export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon openSwarm ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "openSwarmning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
