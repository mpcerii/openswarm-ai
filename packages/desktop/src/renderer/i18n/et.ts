export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse openSwarm uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "openSwarm'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
