export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo openSwarmn uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "openSwarmn versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää openSwarmn uudelleen?",
