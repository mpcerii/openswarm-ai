export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av openSwarm",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av openSwarm har laddats ned. Vill du installera den och starta om programmet?",
