...
const desktopStateNames = ["ai.openswarm.desktop.dev", "ai.openswarm.desktop.beta", "ai.openswarm.desktop"]
...
function executableName() {
  return process.platform === "win32" ? "openswarm-cli.exe" : "openswarm-cli"
}
