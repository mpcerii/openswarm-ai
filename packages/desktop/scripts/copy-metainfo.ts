...
const productName = channel === "prod" ? "openSwarm" : `openSwarm ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      openSwarm is an open source agent that helps you write and run code with any AI model.
    </p>
  </description>
