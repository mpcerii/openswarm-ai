      ...
      .add(
        HttpApiEndpoint.get("list", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of projects that have been opened with openSwarm.",
          }),
        ),
        HttpApiEndpoint.get("current", `${root}/current`, {
          ...
          OpenApi.annotations({
            ...
            description: "Retrieve the currently active project that openSwarm is working with.",
          }),
        ),
