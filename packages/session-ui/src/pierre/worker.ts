...
import { registeropenSwarmTheme } from "@opencode-ai/ui/context/marked-theme-register"

registeropenSwarmTheme()
  ...
  const pool = new WorkerPoolManager(
    {
      ...
      // NOTE: 2 is probably better for openSwarm, as I think 8 might be
