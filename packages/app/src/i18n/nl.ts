export const dict = {
  ...
  "desktop.menu.documentation": "openSwarm-documentatie",
  ...
  "desktop.recovery.loadFailed": "openSwarm kan niet worden geladen",
  "desktop.recovery.terminated": "Het openSwarm-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "openSwarm reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van openSwarm is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De openSwarm-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in openSwarm te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in openSwarm te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in openSwarm te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke openSwarm-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "openSwarm controleren...",
  "wsl.onboarding.checkingOpencodeIn": "openSwarm controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "openSwarm bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "openSwarm bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk openSwarm bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "openSwarm bijwerken",
  "wsl.onboarding.opencodeReadyIn": "openSwarm is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer openSwarm in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat openSwarm een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "openSwarm kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens openSwarm opnieuw.",
  ...
  "help.tabs.introduction": "openSwarm Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van openSwarm ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het openSwarm-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: openSwarm ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de openSwarm-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor openSwarm",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe openSwarm eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of openSwarm het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van openSwarm aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer openSwarm wordt gestart",
  ...
  "settings.updates.toast.latest.title": "openSwarm is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van openSwarm.",
