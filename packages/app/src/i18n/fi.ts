export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "openSwarmn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja openSwarmssa.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja openSwarmssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja openSwarmssa.",
  ...
  "dialog.server.description": "Vaihda openSwarm-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan openSwarma...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan openSwarma kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään openSwarma...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään openSwarma kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä openSwarm jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna openSwarm jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarma ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin openSwarm voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "openSwarm ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten openSwarm uudelleen.",
  ...
  "toast.update.description": "openSwarmn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä openSwarm-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että openSwarm ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita openSwarm-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda openSwarmn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä openSwarm näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö openSwarm järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta openSwarmn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun openSwarm käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät openSwarmn uusinta versiota.",
  ...
  "desktop.menu.documentation": "openSwarm-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "openSwarm-valikko",
  ...
  "desktop.recovery.loadFailed": "openSwarmn lataaminen epäonnistui",
  "desktop.recovery.terminated": "openSwarm-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "openSwarm ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "openSwarmn asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarma ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "openSwarmn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "openSwarm Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
