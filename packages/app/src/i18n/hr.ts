...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "openSwarm se nije uspio učitati",
  "Prozor aplikacije openSwarm neočekivano je zatvoren",
  "openSwarm ne reagira",
  ...
  "Instalacija aplikacije openSwarm nije uspjela",
  ...
  "openSwarm nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije openSwarm je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u openSwarm.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u openSwarm.",
  ...
  "dialog.server.description": "Promijenite na koji se openSwarm poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera openSwarm u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje openSwarm u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte openSwarm u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte openSwarm u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte openSwarm",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što openSwarm može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "openSwarm nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite openSwarm.",
  ...
  "help.tabs.introduction": "Radna površina openSwarm sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija openSwarm ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku openSwarm timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, openSwarm još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "openSwarm Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite openSwarm poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za openSwarm",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako openSwarm izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li openSwarm slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je openSwarm tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se openSwarm pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju openSwarm.",
