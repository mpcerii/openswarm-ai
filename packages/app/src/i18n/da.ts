export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i openSwarm.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i openSwarm.",
  ...
  "dialog.server.description": "Skift hvilken openSwarm-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker openSwarm i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer openSwarm i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater openSwarm i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før openSwarm kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "openSwarm kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter openSwarm igen.",
  ...
  "toast.update.description": "En ny version af openSwarm ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til openSwarm-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, openSwarm understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør openSwarm-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for openSwarm",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan openSwarm ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om openSwarm skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas openSwarms tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når openSwarm starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af openSwarm.",
  ...
  "desktop.recovery.loadFailed": "openSwarm kunne ikke indlæses",
  "desktop.recovery.terminated": "openSwarm-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af openSwarm mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af openSwarm er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "openSwarm Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
