export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja openSwarm",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać openSwarm",
  "desktop.recovery.terminated": "Okno openSwarm zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "openSwarm nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować openSwarm",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja openSwarm została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w openSwarm.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w openSwarm.",
  ...
  "dialog.server.description": "Przełącz serwer openSwarm, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie openSwarm w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie openSwarm w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj openSwarm w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj openSwarm w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim openSwarm będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "openSwarm nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz openSwarm.",
  ...
  "help.tabs.introduction": "openSwarm Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja openSwarm ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu openSwarm",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: openSwarm nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "openSwarm zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer openSwarm wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla openSwarm",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd openSwarm na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy openSwarm ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw openSwarm.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania openSwarm",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji openSwarm.",
