export const dict = {
  ...
  "desktop.recovery.loadFailed": "openSwarm gagal dimuat",
  "desktop.recovery.terminated": "Jendela openSwarm berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "openSwarm tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi openSwarm gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan openSwarm selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di openSwarm.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di openSwarm.",
  ...
  "dialog.server.description": "Ganti server openSwarm mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa openSwarm di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui openSwarm di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui openSwarm di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm siap.",
  "wsl.onboarding.installOpencodeIn": "Instal openSwarm di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum openSwarm dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "openSwarm tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali openSwarm.",
  ...
  "help.tabs.introduction": "openSwarm Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru openSwarm ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim openSwarm",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: openSwarm belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server openSwarm di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk openSwarm",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan openSwarm di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah openSwarm mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat openSwarm diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru openSwarm.",
