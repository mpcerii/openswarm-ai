export const dict = {
  ...
  "desktop.recovery.loadFailed": "openSwarmを読み込めませんでした",
  "desktop.recovery.terminated": "openSwarmのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "openSwarmが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "openSwarmのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはopenSwarmがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "openSwarmのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "openSwarmが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、openSwarmで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してopenSwarmで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、openSwarmで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するopenSwarmサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "openSwarmを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のopenSwarmを確認中...",
  "wsl.onboarding.updatingOpencode": "openSwarmを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のopenSwarmを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のopenSwarmを更新してください。",
  "wsl.onboarding.updateOpencode": "openSwarmを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のopenSwarmの準備ができました。",
  "wsl.onboarding.opencodeReady": "openSwarmの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にopenSwarmをインストールしてください。",
  "wsl.onboarding.installOpencode": "openSwarmをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarmがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "openSwarmでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、openSwarmをもう一度開いてください。",
  ...
  "help.tabs.introduction": "openSwarm Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "openSwarmの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをopenSwarmチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: openSwarmはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "openSwarmには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でopenSwarmサーバーを実行します。",
  ...
  "settings.general.row.language.description": "openSwarmの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのopenSwarmの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "openSwarmがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "openSwarmのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "openSwarm の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "openSwarm は最新バージョンです。",
