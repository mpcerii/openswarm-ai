...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "openSwarm yüklenemedi",
  "desktop.recovery.terminated": "openSwarm penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "openSwarm yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "openSwarm kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "openSwarm güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "openSwarm tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve openSwarm'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak openSwarm'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak openSwarm'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi openSwarm sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "openSwarm kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde openSwarm kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "openSwarm güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde openSwarm güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki openSwarm'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "openSwarm'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde openSwarm hazır.",
  "wsl.onboarding.opencodeReady": "openSwarm hazır.",
  "wsl.onboarding.installOpencodeIn": "openSwarm'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "openSwarm'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "openSwarm'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "openSwarm bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından openSwarm'u tekrar açın.",
  ...
  "help.tabs.introduction": "openSwarm Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "openSwarm'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı openSwarm ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: openSwarm henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "openSwarm Masaüstü",
  ...
  "settings.desktop.wsl.description": "openSwarm sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "openSwarm'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "openSwarm'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "openSwarm'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "openSwarm'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "openSwarm başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "openSwarm'un en son sürümünü kullanıyorsunuz.",
