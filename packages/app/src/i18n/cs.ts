export const dict = {
  ...
  "desktop.menu.documentation": "openSwarm Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka openSwarm",
  ...
  "desktop.recovery.loadFailed": "openSwarm se nepodařilo načíst",
  "desktop.recovery.terminated": "openSwarm okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "openSwarm nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "openSwarm instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "openSwarm aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v openSwarm.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v openSwarm.",
  ...
  "dialog.server.description": "Přepněte, ke kterému openSwarm serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola openSwarm v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace openSwarm v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace openSwarm v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte openSwarm do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než openSwarm může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "openSwarm nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete openSwarm.",
  ...
  "help.tabs.introduction": "openSwarm Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze openSwarm ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu openSwarm",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: openSwarm zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server openSwarm uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro openSwarm",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled openSwarm na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude openSwarm následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma openSwarm.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění openSwarm",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi openSwarm.",
