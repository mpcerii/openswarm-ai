export const dict = {
  ...
  "desktop.recovery.loadFailed": "openSwarm yüklənə bilmədi",
  "desktop.recovery.terminated": "openSwarm pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "openSwarm cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "openSwarm quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "openSwarm yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "openSwarm tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və openSwarm-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və openSwarm-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və openSwarm-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu openSwarm serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "openSwarm yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də openSwarm yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "openSwarm yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də openSwarm yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də openSwarm-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "openSwarm-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "openSwarm {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "openSwarm hazırdır.",
  "wsl.onboarding.installOpencodeIn": "openSwarm-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "openSwarm quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "openSwarm WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "openSwarm bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra openSwarm-u yenidən açın.",
  ...
  "help.tabs.introduction": "openSwarm Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "openSwarm-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı openSwarm komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: openSwarm hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində openSwarm serverini işlət.",
  ...
  "settings.general.row.language.description": "openSwarm üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "openSwarm-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "openSwarm-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "openSwarm-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "openSwarm açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "openSwarm-un ən son versiyasından istifadə edirsiniz.",
