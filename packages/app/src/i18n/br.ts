export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do openSwarm",
  ...
  "desktop.menu.ariaLabel": "Menu do openSwarm",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o openSwarm",
  "desktop.recovery.terminated": "A janela do openSwarm foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O openSwarm não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do openSwarm",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O openSwarm não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do openSwarm foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no openSwarm.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no openSwarm.",
  ...
  "dialog.server.description": "Trocar para qual servidor openSwarm este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o openSwarm em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o openSwarm em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o openSwarm em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o openSwarm",
  "wsl.onboarding.opencodeReadyIn": "O openSwarm está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O openSwarm está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o openSwarm em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o openSwarm possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O openSwarm não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o openSwarm novamente.",
  ...
  "help.tabs.introduction": "Agora, o openSwarm Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do openSwarm ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do openSwarm",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: openSwarm ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor openSwarm dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do openSwarm",
  ...
  "settings.general.row.appearance.description": "Personalize como o openSwarm aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o openSwarm segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o openSwarm é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o openSwarm iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do openSwarm.",
