export const dict = {
  ...
  "desktop.recovery.loadFailed": "openSwarm laadimine ebaõnnestus",
  "desktop.recovery.terminated": "openSwarm aken suleti ootamatult",
  "desktop.recovery.unresponsive": "openSwarm ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "openSwarm installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "openSwarm värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid openSwarm'is.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises openSwarm.",
  ...
  "dialog.server.description": "Lülitage, millise openSwarm serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "openSwarm kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "openSwarm kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "openSwarm värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "openSwarm värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda openSwarm jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige openSwarm asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui openSwarm saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "openSwarm ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti openSwarm.",
  ...
  "help.tabs.introduction": "openSwarm Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse openSwarm ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast openSwarm meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, openSwarm ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "openSwarm Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage openSwarm server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke openSwarm kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas openSwarm teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas openSwarm järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas openSwarm on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui openSwarm käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse openSwarm uusimat versiooni.",
