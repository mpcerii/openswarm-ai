...
export const dict = {
  ...
  "desktop.menu.documentation": "openSwarm-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "openSwarm-meny",
  ...
  "desktop.recovery.loadFailed": "openSwarm kunne ikke lastes inn",
  "desktop.recovery.terminated": "openSwarm-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "openSwarm svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av openSwarm mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av openSwarm er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i openSwarm.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i openSwarm.",
  ...
  "dialog.server.description": "Bytt hvilken openSwarm-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av openSwarm ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til openSwarm-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at openSwarm ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør openSwarm-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for openSwarm",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan openSwarm ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om openSwarm skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i openSwarm.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når openSwarm starter",
  ...
  "settings.updates.toast.latest.title": "openSwarm er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av openSwarm.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker openSwarm i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer openSwarm i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater openSwarm i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer openSwarm i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før openSwarm kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "openSwarm kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter openSwarm på nytt.",
  ...
  "help.tabs.introduction": "openSwarm Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
