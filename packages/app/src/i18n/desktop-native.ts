...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "openSwarm failed to load",
  "desktop.recovery.terminated": "openSwarm window terminated unexpectedly",
  "desktop.recovery.unresponsive": "openSwarm is not responding",
  ...
  "desktop.wsl.error.installOpencode": "openSwarm installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "openSwarm update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
