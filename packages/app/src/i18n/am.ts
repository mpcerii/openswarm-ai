export const dict = {
  ...
  "desktop.recovery.loadFailed": "openSwarm መጫን አልቻለም",
  "desktop.recovery.terminated": "openSwarm መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "openSwarm ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "openSwarmመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "openSwarm ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በopenSwarm",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በopenSwarm ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "openSwarm ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በopenSwarm ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በopenSwarm ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው openSwarm አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "openSwarmን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ openSwarm በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን openSwarm በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "openSwarm ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን openSwarm በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarmአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) openSwarm WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "openSwarm በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ openSwarm።",
  ...
  "help.tabs.introduction": "openSwarm ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የopenSwarm ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለopenSwarm ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ openSwarm እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "openSwarm ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "openSwarm ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የopenSwarm አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለopenSwarm",
  ...
  "settings.general.row.appearance.description": "openSwarmበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "openSwarm ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "openSwarm ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "openSwarm ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የopenSwarm እትም እያሄዱ ነው።",
