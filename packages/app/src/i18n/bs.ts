export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za openSwarm",
  ...
  "desktop.menu.ariaLabel": "openSwarm meni",
  ...
  "desktop.recovery.loadFailed": "openSwarm se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor openSwarm-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "openSwarm ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija openSwarm-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje openSwarm-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u openSwarm-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u openSwarm-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u openSwarm-u.",
  ...
  "dialog.server.description": "Promijeni na koji se openSwarm server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera openSwarm u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje openSwarm u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj openSwarm u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj openSwarm u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi openSwarm mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "openSwarm nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori openSwarm.",
  ...
  "help.tabs.introduction": "openSwarm Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija openSwarm-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku openSwarm timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: openSwarm još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni openSwarm server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u openSwarm-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako openSwarm izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li openSwarm prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu openSwarm-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se openSwarm pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju openSwarm-a.",
