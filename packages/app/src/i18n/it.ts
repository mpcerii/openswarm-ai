export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in openSwarm.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in openSwarm.",
  ...
  "dialog.server.description": "Cambia il server openSwarm a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo openSwarm in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento openSwarm in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna openSwarm in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa openSwarm in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che openSwarm possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "openSwarm non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri openSwarm.",
  ...
  "help.tabs.introduction": "openSwarm Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di openSwarm ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team openSwarm",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: openSwarm non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server openSwarm all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per openSwarm",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di openSwarm sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se openSwarm segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di openSwarm.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di openSwarm",
  ...
  "settings.updates.toast.latest.title": "openSwarm è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di openSwarm.",
  ...
  "desktop.menu.documentation": "Documentazione di openSwarm",
  ...
  "desktop.menu.ariaLabel": "Menu openSwarm",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare openSwarm",
  "desktop.recovery.terminated": "La finestra di openSwarm si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "openSwarm non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di openSwarm non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di openSwarm è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
