...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "openSwarm įkelti nepavyko",
  "openSwarm langas netikėtai užsidarė",
  "openSwarm neatsako",
  ...
  "openSwarm įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "openSwarm neįdiegtas distributyve {{distro}}",
  "openSwarm naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami openSwarm modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje openSwarm.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius openSwarm.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio openSwarm serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama openSwarm {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas openSwarm {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite openSwarm {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite openSwarm į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad openSwarm galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "openSwarm nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite openSwarm.",
  ...
  "help.tabs.introduction": "openSwarm Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują openSwarm ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą openSwarm komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad openSwarm dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "openSwarm apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "openSwarm darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite openSwarm serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite openSwarm ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip openSwarm atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar openSwarm seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite openSwarm temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas openSwarm",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią openSwarm versiją.",
