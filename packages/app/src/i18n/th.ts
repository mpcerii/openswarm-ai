export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด openSwarm ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง openSwarm หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "openSwarm ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installOpencode": "การติดตั้ง openSwarm ล้มเหลว",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ไม่ได้ติดตั้ง openSwarm ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต openSwarm เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย openSwarm",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน openSwarm",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน openSwarm",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน openSwarm",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ openSwarm ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingOpencode": "กำลังตรวจสอบ openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "กำลังตรวจสอบ openSwarm ใน {{distro}}...",
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "กำลังอัปเดต openSwarm ใน {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "อัปเดต openSwarm ใน {{distro}}",
  "wsl.onboarding.updateOpencode": "อัปเดต openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.opencodeReady": "openSwarm พร้อมใช้งานแล้ว",
  "wsl.onboarding.installOpencodeIn": "ติดตั้ง openSwarm ใน {{distro}}",
  "wsl.onboarding.installOpencode": "ติดตั้ง openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ยังไม่ได้ติดตั้ง openSwarm",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ openSwarm จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "openSwarm ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด openSwarm อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ openSwarm Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ openSwarm ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม openSwarm",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า openSwarm ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "openSwarm รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ openSwarm ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ openSwarm",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ openSwarm บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ openSwarm ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ openSwarm",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ openSwarm เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน openSwarm เวอร์ชันล่าสุด",
