...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in openSwarm zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in openSwarm zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in openSwarm zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den openSwarm-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "openSwarm",
  ...
  "wsl.onboarding.checkingOpencode": "openSwarm wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "openSwarm in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "openSwarm wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "openSwarm in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie openSwarm in {{distro}}.",
  "wsl.onboarding.updateOpencode": "openSwarm aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "openSwarm ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "openSwarm ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie openSwarm in {{distro}}.",
  "wsl.onboarding.installOpencode": "openSwarm installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor openSwarm einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "openSwarm konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann openSwarm erneut.",
  ...
  "toast.update.description": "Eine neue Version von openSwarm ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem openSwarm-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: openSwarm unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "openSwarm mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "openSwarm enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "openSwarm Desktop",
  ...
  "settings.desktop.wsl.description": "openSwarm-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für openSwarm ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie openSwarm auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob openSwarm dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von openSwarm anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von openSwarm automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "openSwarm ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von openSwarm wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "openSwarm konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das openSwarm-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "openSwarm reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "openSwarm-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das openSwarm-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "openSwarm Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
