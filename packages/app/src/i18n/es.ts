export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de openSwarm",
  ...
  "desktop.menu.ariaLabel": "Menú de openSwarm",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar openSwarm",
  "desktop.recovery.terminated": "La ventana de openSwarm se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "openSwarm no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar openSwarm",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de openSwarm finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en openSwarm.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en openSwarm.",
  ...
  "dialog.server.description": "Cambiar el servidor de openSwarm al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando openSwarm en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando openSwarm en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza openSwarm en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala openSwarm en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que openSwarm pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "openSwarm no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir openSwarm.",
  ...
  "help.tabs.introduction": "openSwarm Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de openSwarm ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de openSwarm",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: openSwarm aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor openSwarm dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para openSwarm",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve openSwarm en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si openSwarm sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de openSwarm.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia openSwarm",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de openSwarm.",
