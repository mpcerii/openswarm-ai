export const dict = {
  ...
  "desktop.menu.documentation": "openSwarm दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "openSwarm मेन्यू",
  ...
  "desktop.recovery.loadFailed": "openSwarm लोड नहीं हो सका",
  "desktop.recovery.terminated": "openSwarm विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "openSwarm प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installOpencode": "openSwarm इंस्टॉल नहीं हो सका",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} में openSwarm इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "openSwarm अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "dialog.model.unpaid.freeModels.title": "openSwarm द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और openSwarm में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen आपको कोडिंग एजेंटों के लिए चुने गए विश्वसनीय, अनुकूलित मॉडलों तक पहुँच देता है।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और openSwarm में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा openSwarm में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस openSwarm सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingOpencode": "openSwarm की जाँच हो रही है...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} में openSwarm की जाँच हो रही है...",
  "wsl.onboarding.updatingOpencode": "openSwarm अपडेट हो रहा है...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} में openSwarm अपडेट हो रहा है...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} में openSwarm को अपडेट करें।",
  "wsl.onboarding.updateOpencode": "openSwarm को अपडेट करें",
  "wsl.onboarding.opencodeReadyIn": "openSwarm {{distro}} में तैयार है।",
  "wsl.onboarding.opencodeReady": "openSwarm तैयार है।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} में openSwarm स्थापित करें।",
  "wsl.onboarding.installOpencode": "openSwarm स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "openSwarm द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "openSwarm इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर openSwarm को फिर से खोलें।",
  ...
  "help.tabs.introduction": "openSwarm Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "openSwarm ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट openSwarm टीम को करें",
  ...
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, openSwarm अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "openSwarm में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर openSwarm सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "openSwarm के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि openSwarm आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि openSwarm सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि openSwarm की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "openSwarm लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप openSwarm का नवीनतम संस्करण चला रहे हैं।",
