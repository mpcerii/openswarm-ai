export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi openSwarm",
  ...
  "desktop.recovery.loadFailed": "openSwarm gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap openSwarm ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "openSwarm tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan openSwarm gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini openSwarm selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam openSwarm.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam openSwarm.",
  ...
  "dialog.server.description": "Tukar pelayan openSwarm yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak openSwarm dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini openSwarm dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini openSwarm dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang openSwarm dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum openSwarm boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "openSwarm tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula openSwarm.",
  ...
  "help.tabs.introduction": "openSwarm Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu openSwarm ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan openSwarm",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, openSwarm belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan openSwarm dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk openSwarm",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa openSwarm pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada openSwarm mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema openSwarm.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila openSwarm dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini openSwarm.",
