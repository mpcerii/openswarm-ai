export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'openSwarm",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'openSwarm",
  "desktop.recovery.terminated": "La fenêtre openSwarm s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "openSwarm ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'openSwarm",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'openSwarm est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans openSwarm.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans openSwarm.",
  ...
  "dialog.server.description": "Changez le serveur openSwarm auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'openSwarm dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'openSwarm dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour openSwarm dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez openSwarm dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'openSwarm puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "openSwarm n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez openSwarm.",
  ...
  "help.tabs.introduction": "openSwarm Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'openSwarm ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe openSwarm",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'openSwarm ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "openSwarm inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur openSwarm dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour openSwarm",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'openSwarm sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si openSwarm suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'openSwarm.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'openSwarm",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'openSwarm.",
