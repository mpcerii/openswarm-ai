export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu openSwarm",
  ...
  "desktop.recovery.loadFailed": "Không tải được openSwarm",
  "desktop.recovery.terminated": "Cửa sổ openSwarm đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "openSwarm không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được openSwarm",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật openSwarm nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do openSwarm cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong openSwarm.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong openSwarm.",
  ...
  "dialog.server.description": "Chuyển máy chủ openSwarm mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra openSwarm trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật openSwarm trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật openSwarm trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt openSwarm trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi openSwarm có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "openSwarm không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại openSwarm.",
  ...
  "help.tabs.introduction": "openSwarm Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của openSwarm ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm openSwarm",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: openSwarm chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ openSwarm bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho openSwarm",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của openSwarm trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem openSwarm tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của openSwarm.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi openSwarm khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của openSwarm.",
