export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل openSwarm",
  "desktop.recovery.terminated": "توقفت نافذة openSwarm بشكل غير متوقع",
  "desktop.recovery.unresponsive": "openSwarm لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت openSwarm",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث openSwarm، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من openSwarm",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في openSwarm.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك openSwarm Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في openSwarm.",
  ...
  "dialog.server.description": "تبديل خادم openSwarm الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من openSwarm في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث openSwarm في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث openSwarm في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت openSwarm في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن openSwarm من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على openSwarm التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح openSwarm.",
  ...
  "help.tabs.introduction": "أصبح openSwarm Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من openSwarm ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق openSwarm",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن openSwarm لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن openSwarm نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم openSwarm داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ openSwarm",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور openSwarm على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان openSwarm يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة openSwarm.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل openSwarm",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من openSwarm.",
