export const dict = {
  ...
  "desktop.menu.documentation": "openSwarm Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "openSwarm μενού",
  ...
  "desktop.recovery.loadFailed": "openSwarm απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "openSwarm το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "openSwarm δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "openSwarm η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "openSwarm η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο openSwarm.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο openSwarm.",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή openSwarm συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος openSwarm σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση openSwarm σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση openSwarm σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του openSwarm στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο openSwarm να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "openSwarm δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το openSwarm.",
  ...
  "help.tabs.introduction": "openSwarm Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του openSwarm ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα openSwarm",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το openSwarm δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "openSwarm Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή openSwarm μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το openSwarm",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του openSwarm στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το openSwarm ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το openSwarm.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του openSwarm",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του openSwarm.",
