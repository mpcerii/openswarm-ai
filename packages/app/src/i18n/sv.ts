export const dict = {
  ...
  "desktop.recovery.loadFailed": "openSwarm kunde inte läsas in",
  "desktop.recovery.terminated": "openSwarm-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "openSwarm svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av openSwarm misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "openSwarm är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "openSwarm-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i openSwarm.",
  ...
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i openSwarm.",
  ...
  "dialog.server.description": "Växla vilken openSwarm-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar openSwarm i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar openSwarm i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera openSwarm i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera openSwarm i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan openSwarm kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "openSwarm kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan openSwarm igen.",
  ...
  "help.tabs.introduction": "openSwarm Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av openSwarm ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till openSwarm-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, openSwarm stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör openSwarm-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för openSwarm",
  ...
  "settings.general.row.appearance.description": "Anpassa hur openSwarm ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om openSwarm följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa openSwarms tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när openSwarm startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av openSwarm.",
