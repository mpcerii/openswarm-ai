...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by openSwarm",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in openSwarm.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "openSwarm Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in openSwarm.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in openSwarm.",
  ...
  "dialog.server.description": "Switch which openSwarm server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking openSwarm...",
  "wsl.onboarding.checkingOpencodeIn": "Checking openSwarm in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating openSwarm...",
  "wsl.onboarding.updatingOpencodeIn": "Updating openSwarm in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update openSwarm in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update openSwarm",
  "wsl.onboarding.opencodeReadyIn": "openSwarm is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "openSwarm is ready.",
  "wsl.onboarding.installOpencodeIn": "Install openSwarm in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install openSwarm",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "openSwarm not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before openSwarm can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "openSwarm could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen openSwarm.",
  ...
  "help.tabs.introduction": "openSwarm Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of openSwarm ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the openSwarm team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, openSwarm does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "openSwarm includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the openSwarm server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for openSwarm",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how openSwarm looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether openSwarm follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how openSwarm is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when openSwarm launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of openSwarm.",
