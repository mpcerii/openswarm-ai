import type { openSwarmEvent, SessionMessageInfo, SessionPendingMessage } from "@opencode-ai/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: openSwarmEvent): V2SessionReduction | undefined => {
