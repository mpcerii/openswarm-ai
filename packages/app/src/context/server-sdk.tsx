...
export type ServerEvent = Event & { current?: openSwarmEvent }
...
export function adaptServerEvent(event: openSwarmEvent): ServerEvent {
...
function currentDelta(event: openSwarmEvent | undefined): CurrentDelta | undefined {
  if (
